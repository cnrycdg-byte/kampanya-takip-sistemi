-- ============================================
-- MANUEL OLARAK 13 MARKA İLE ANKET OLUŞTUR
-- ============================================

-- 1. Yeni anket oluştur
INSERT INTO surveys (title, description, month, year, status) 
VALUES ('Test Anketi - Ekim 2025 v3', 'Test anketi - 13 marka ile manuel', 10, 2025, 'active')
RETURNING id;

-- Bu ID'yi not alın (örneğin 3 çıktı diyelim)

-- 2. SORU 1: Promotör Sayısı (13 marka)
...
-- 3. SORU 2: Yatırım Alanı (13 marka)
INSERT INTO survey_questions (survey_id, question_text, question_type, question_order, question_config, is_required) 
VALUES (
    3, -- YUKARIDAKİ ID'Yİ BURAYA YAZIN
...
-- 4. SORU 3: Sepet Analizi (13 marka)
INSERT INTO survey_questions (survey_id, question_text, question_type, question_order, question_config, is_required) 
VALUES (
    3, -- YUKARIDAKİ ID'Yİ BURAYA YAZIN
...
-- ============================================
-- BAŞARILI! 
-- 13 marka ile yeni anket oluşturuldu.
-- ============================================
