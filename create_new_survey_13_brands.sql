-- ============================================
-- YENİ ANKET OLUŞTUR - 13 MARKA İLE
-- ============================================

-- 1. Mevcut tüm anketleri temizle
...
VALUES ('Test Anketi - Ekim 2025 v6', 'Test anketi - 13 marka ile', 10, 2025, 'active')
RETURNING id;

-- Bu ID'yi not alın (örneğin 8 çıktı diyelim)
...
VALUES (
    8, -- YUKARIDAKİ ID'Yİ BURAYA YAZIN
...
WHERE s.id = 8 -- YUKARIDAKİ ID'Yİ BURAYA YAZIN
GROUP BY s.id, s.title, sq.question_type, sq.question_config
